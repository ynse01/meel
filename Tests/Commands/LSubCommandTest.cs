...
namespace Meel.Tests.Commands
{
    ...
    {
        [Test]
        public void ShouldListOnlySubscribedBoxes()
        {
            // Arrange
            ...
            var command = new LSubCommand(station);
            ...
            StringAssert.DoesNotContain(unsub, txt);
        }
        ...
        public void ShouldReturnFlags()
        {
            ...
            box.SetSubscribed(true);
            station.CreateMailbox(user, otherName);
            var other = (InMemoryMailbox)station.SelectMailbox(user, otherName);
